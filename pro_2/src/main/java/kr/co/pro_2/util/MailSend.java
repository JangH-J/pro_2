...
public class MailSend {
	...
	public int setEmail(String email, String subject, String body) throws Exception 
	{
	     ...
	     final String username = "bachelorchuckchuck"; // 송신자 네이버 아이디
	     final String password = "ek2dkahsem*wl"; // 송신자 네이버 비밀번호
	     int port=465;
	     int state=0;
	     ...
	     mimeMessage.setFrom(new InternetAddress("bachelorchuckchuck@naver.com")); // 송신자 네이버 주소
