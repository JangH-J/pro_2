...
public class CustomController {
	...
	@RequestMapping("custom_write")
	public String custom_write()
	{
		return module+"/custom_write";
	}
	
	@RequestMapping("custom_write_ok")
	...
	@RequestMapping("custom_update_ok")
